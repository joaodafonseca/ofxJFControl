...
void ofxJFControlGroup::addSlider(string _name, float &_val, float _min, float _max){
    
    int yLoc=initialWigetYlocation();
    controls.push_back(new ofxJFSlider(_name, _val, _min, _max, location.x, yLoc,size.x,widgetHeight));
